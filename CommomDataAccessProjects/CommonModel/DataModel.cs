...
namespace KangShuoTech.CommomDataAccessProjects.CommonModel
{
    public class DataModel
    {
        ...
        public string P_LCC { get; set; }//大血小板数目

        //新增血球
        public string HLR_B { get; set; }//巨大未成熟细胞百分比
        public string HLR_N { get; set; }//巨大未成熟细胞数目
        public string ALY_B { get; set; }//异常淋巴细胞百分比
        public string ALY_N { get; set; }//异常淋巴细胞数目
        public string NRBC_N { get; set; }//有核红细胞数目
        public string NRBC_B { get; set; }//有核红细胞百分比
        public string HGB { get; set; }//血红蛋白浓度
        ...
        //新增尿检同步
        public string MALB { get; set; }//微白蛋白
        ...
        #region B超项目
        public string ArchivesNum { get; set; }//档案编号
        public string CheckNum { get; set; }//超声编号
        public string CheckPart { get; set; }//检查部位
        public string ModSee { get; set; }//超声所见
        public string ModDia { get; set; }//超声提示
        public string PicPath { get; set; }//报告路径名称
        #endregion

        #region 安徽X光

        public string PID { get; set; }//DR客户端编号
        public string ReportName { get; set; }//报告编号
        public string PersonName { get; set; }//姓名
        public string Sex { get; set; }//性别
        public string Age { get; set; }//年龄
        public string BodyPartExamined { get; set; }//检查部位
        public string Procedure { get; set; }//拍片部位
