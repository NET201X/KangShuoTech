namespace CommomUtilities.Common
{
    ...
    public class TimeParser
    {
        ...
        public string ConvertToChineseCapital(DateTime dateTime)
        {
            var year = NumToUpper(dateTime.Year) + "年";
            var month = MonthToUpper(dateTime.Month) + "月";
            var day = MonthToUpper(dateTime.Day) + "日";
