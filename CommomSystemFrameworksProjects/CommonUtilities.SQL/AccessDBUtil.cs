...
namespace CommonUtilities.SQL
{
    ...
    {       
        ...
        public static string strCommon { set; get; }
        ...
        public static string connectionString
        {
            get
            {
                if (File.Exists(Application.StartupPath + @"\PadPlatform.exe.config"))
                {
                    ...
                    config.ConnectionStrings.ConnectionStrings["QCshenghua"].ConnectionString.ToString();
        ...
        private static void GetConnctStr()
        {
            if (!string.IsNullOrEmpty(strCommon))
            {
                connectionString = ConfigurationManager.ConnectionStrings[strCommon].ToString();
            }
            else
            {
                connectionString = ConfigurationManager.ConnectionStrings["QCshenghua"].ToString();
            }
        }
        ...
        public static int ExecuteScalar(string sql, OleDbParameter[] parameters, string conn)
        {
        ...
        //执行查询语句，返回dataset
        public static DataSet ExecuteQuery(string sql, OleDbParameter[] parameters, string conn)
        {
            if (conn == "") conn = connectionString;
        ...
        public static DataSet ExecuteQuery(string sql, string conn)
        {
        ...
        public static bool GetTables(string name, string conn)
        {
            if (conn == "") conn = connectionString;
