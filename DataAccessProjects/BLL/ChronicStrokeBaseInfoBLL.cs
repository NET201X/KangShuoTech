namespace KangShuoTech.DataAccessProjects.BLL
{
    ...
    public class ChronicStrokeBaseInfoBLL
    {
        private readonly ChronicStrokeBaseInfoDAL dal = new ChronicStrokeBaseInfoDAL();
        ...
        public ChronicStrokeBaseInfoModel GetModelByCache(int ID)
        {
            string cacheKey = "CD_STROKE_BASEINFOModel-" + ID;
            ...
            return (ChronicStrokeBaseInfoModel) cache;
        }

        public List<ChronicStrokeBaseInfoModel> GetModelList(string strWhere)
        {
