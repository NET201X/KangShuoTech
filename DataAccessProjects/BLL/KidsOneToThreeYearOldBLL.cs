namespace KangShuoTech.DataAccessProjects.BLL
{
    ...
    public class KidsOneToThreeYearOldBLL
    {
        private readonly KidsOneToThreeYearOldDAL dal = new KidsOneToThreeYearOldDAL();
        ...
        public KidsOneToThreeYearOldModel GetModelByCache(string IDCardNo)
        {
            string cacheKey = "CHILD_ONE2THREE_YEAR_OLDModel-" + IDCardNo;
            ...
            return (KidsOneToThreeYearOldModel)cache;
        }

        public List<KidsOneToThreeYearOldModel> GetModelList(string strWhere)
        {
