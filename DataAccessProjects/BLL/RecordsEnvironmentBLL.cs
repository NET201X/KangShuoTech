namespace KangShuoTech.DataAccessProjects.BLL
{
    ...
    public class RecordsEnvironmentBLL
    {
        ...
        public RecordsEnvironmentModel GetModelByCache(string IDCardNo)
        {
            string cacheKey = "ARCHIVE_ENVIRONMENTModel-" + IDCardNo;
            ...
            return (RecordsEnvironmentModel)cache;
        }

        public List<RecordsEnvironmentModel> GetModelList(string strWhere)
        {
