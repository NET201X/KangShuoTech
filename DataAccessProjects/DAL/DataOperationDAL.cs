...
namespace KangShuoTech.DataAccessProjects.DAL
{
    ...
    public class DataOperationDAL
    {
        ...
        //    sQLStringList.Add("delete from ARCHIVE_BASEINFO");
        ...
        //    sQLStringList.Add("delete from ARCHIVE_DEVICEINFO");
        ...
        public DataTable GetStatistics()
        {
            ...
            DataTable datatable = MySQLHelper.GetDataTable(this.getStatisticsSql("创建个人档案", "ARCHIVE_BASEINFO"));
            DataTable dtb = MySQLHelper.GetDataTable(this.getStatisticsSql("体检信息", "ARCHIVE_CUSTOMERBASEINFO", "CheckDate"));
            DataTable table4 = MySQLHelper.GetDataTable(this.getStatisticsSql("高血压补充表", "CD_HYPERTENSION_BASEINFO"));
            DataTable table5 = MySQLHelper.GetDataTable(this.getStatisticsSql("高血压随访", "CD_HYPERTENSIONFOLLOWUP", "FollowUpDate"));
            DataTable table6 = MySQLHelper.GetDataTable(this.getStatisticsSql("糖尿病补充表", "CD_DIABETES_BASEINFO"));
            DataTable table7 = MySQLHelper.GetDataTable(this.getStatisticsSql("糖尿病随访", "CD_DIABETESFOLLOWUP", "VisitDate"));
            DataTable table8 = MySQLHelper.GetDataTable(this.getStatisticsSql("精神病补充表", "CD_MENTALDISEASE_BASEINFO"));
            DataTable table9 = MySQLHelper.GetDataTable(this.getStatisticsSql("精神病随访", "CD_MENTALDISEASE_FOLLOWUP", "FollowUpDate"));
            DataTable table10 = MySQLHelper.GetDataTable(this.getStatisticsSql("儿童基本信息", "CHILD_BASEINFO"));
            DataTable table11 = MySQLHelper.GetDataTable(this.getStatisticsSql("新生儿随访", "CHILD_NEWBORN_FOLLOWUP", "InterviewDate"));
            DataTable table12 = MySQLHelper.GetDataTable(this.getStatisticsSql("一岁内随访", "CHILD_WITHIN_ONE_YEAR_OLD", "VisitDate"));
            DataTable table13 = MySQLHelper.GetDataTable(this.getStatisticsSql("一至二岁随访", "CHILD_ONE2THREE_YEAR_OLD", "FollowupDate"));
            DataTable table14 = MySQLHelper.GetDataTable(this.getStatisticsSql("三至六岁随访", "CHILD_THREE2SIX_YEAR_OLD", "VisitDate"));
            DataTable table15 = MySQLHelper.GetDataTable(this.getStatisticsSql("孕妇基本信息", "GRAVIDA_BASEINFO"));
            DataTable table16 = MySQLHelper.GetDataTable(this.getStatisticsSql("第一次产前随访", "GRAVIDA_FIRSTFOLLOWUP", "RecordDate"));
            DataTable table17 = MySQLHelper.GetDataTable(this.getStatisticsSql("二到五次产前随访", "GRAVIDA_TWO2FIVE_FOLLOWUP", "FollowupDate"));
            DataTable table18 = MySQLHelper.GetDataTable(this.getStatisticsSql("产后访视", "GRAVIDA_POSTPARTUM", "FollowupDate"));
            DataTable table19 = MySQLHelper.GetDataTable(this.getStatisticsSql("产后42天访视", "GRAVIDA_POSTPARTUM_42DAY", "FollowupDate"));
            ...
            DataTable table20 = MySQLHelper.GetDataTable("select distinct DeviceName from ARCHIVE_DEVICEINFO ");
        ...
        public DataTable GetTimeBucketStatis(string starttime,string endtime,  int timebucket)
        {
            ...
            DataTable datatable = MySQLHelper.GetDataTable(this.getStatisticsSql("创建个人档案", "ARCHIVE_BASEINFO",starttime,endtime, timebucket));
            DataTable dtb = MySQLHelper.GetDataTable(this.getStatisticsSql("体检信息", "ARCHIVE_CUSTOMERBASEINFO", "CheckDate", starttime, endtime, timebucket));
            DataTable table4 = MySQLHelper.GetDataTable(this.getStatisticsSql("高血压补充表", "CD_HYPERTENSION_BASEINFO", starttime, endtime, timebucket));
            DataTable table5 = MySQLHelper.GetDataTable(this.getStatisticsSql("高血压随访", "CD_HYPERTENSIONFOLLOWUP", "FollowUpDate", starttime, endtime, timebucket));
            DataTable table6 = MySQLHelper.GetDataTable(this.getStatisticsSql("糖尿病补充表", "CD_DIABETES_BASEINFO", starttime, endtime, timebucket));
            DataTable table7 = MySQLHelper.GetDataTable(this.getStatisticsSql("糖尿病随访", "CD_DIABETESFOLLOWUP", "VisitDate", starttime, endtime, timebucket));
            DataTable table8 = MySQLHelper.GetDataTable(this.getStatisticsSql("精神病补充表", "CD_MENTALDISEASE_BASEINFO", starttime, endtime, timebucket));
            DataTable table9 = MySQLHelper.GetDataTable(this.getStatisticsSql("精神病随访", "CD_MENTALDISEASE_FOLLOWUP", "FollowUpDate", starttime, endtime, timebucket));
            DataTable table10 = MySQLHelper.GetDataTable(this.getStatisticsSql("儿童基本信息", "CHILD_BASEINFO", starttime, endtime, timebucket));
            DataTable table11 = MySQLHelper.GetDataTable(this.getStatisticsSql("新生儿随访", "CHILD_NEWBORN_FOLLOWUP", "InterviewDate", starttime, endtime, timebucket));
            DataTable table12 = MySQLHelper.GetDataTable(this.getStatisticsSql("一岁内随访", "CHILD_WITHIN_ONE_YEAR_OLD", "VisitDate", starttime, endtime, timebucket));
            DataTable table13 = MySQLHelper.GetDataTable(this.getStatisticsSql("一至二岁随访", "CHILD_ONE2THREE_YEAR_OLD", "FollowupDate", starttime, endtime, timebucket));
            DataTable table14 = MySQLHelper.GetDataTable(this.getStatisticsSql("三至六岁随访", "CHILD_THREE2SIX_YEAR_OLD", "VisitDate", starttime, endtime, timebucket));
            DataTable table15 = MySQLHelper.GetDataTable(this.getStatisticsSql("孕妇基本信息", "GRAVIDA_BASEINFO", starttime, endtime, timebucket));
            DataTable table16 = MySQLHelper.GetDataTable(this.getStatisticsSql("第一次产前随访", "GRAVIDA_FIRSTFOLLOWUP", "RecordDate", starttime, endtime, timebucket));
            DataTable table17 = MySQLHelper.GetDataTable(this.getStatisticsSql("二到五次产前随访", "GRAVIDA_TWO2FIVE_FOLLOWUP", "FollowupDate", starttime, endtime, timebucket));
            DataTable table18 = MySQLHelper.GetDataTable(this.getStatisticsSql("产后访视", "GRAVIDA_POSTPARTUM", "FollowupDate", starttime, endtime, timebucket));
            DataTable table19 = MySQLHelper.GetDataTable(this.getStatisticsSql("产后42天访视", "GRAVIDA_POSTPARTUM_42DAY", "FollowupDate",starttime,endtime, timebucket));
            this.addrow(dta, datatable);
            this.addrow(dta, dtb);
            this.addrow(dta, table4);
            this.addrow(dta, table5);
        ...
        private string getStatisticsSql(string name, string table,string starttime,string endtime,int timebucket)
        {
            ...
            if (timebucket == 1)
            {
                ...
                str = str + " from ARCHIVE_BASEINFO  limit 0,1";
        ...
        private string getStatisticsSql_dev(string name, bool bcc)
        {
            if (bcc)
            {
                return string.Format("select '{0}'\r\n, (select count(*) from ARCHIVE_DEVICEINFO where UpdateData like '{1}%'  and DeviceName = '{0}') as  a \r\n, (select count(*) from ARCHIVE_DEVICEINFO where UpdateData like '{2}%'  and DeviceName = '{0}') as  a \r\n, (select count(*) from ARCHIVE_DEVICEINFO where UpdateData like '{3}%'  and DeviceName = '{0}') as  a \r\n, (select count(*) from ARCHIVE_DEVICEINFO where UpdateData like '{4}%'  and DeviceName = '{0}') as  a \r\n, (select count(*) from ARCHIVE_DEVICEINFO where UpdateData like '{5}%'  and DeviceName = '{0}') as  a \r\n, (select count(*) from ARCHIVE_DEVICEINFO where UpdateData like '{6}%'  and DeviceName = '{0}') as  a \r\n, (select count(*) from ARCHIVE_DEVICEINFO where UpdateData like '{7}%'  and DeviceName = '{0}') as  a ", new object[] { name, DateTime.Today.AddDays(-6.0).ToString("yyyy/M/d"), DateTime.Today.AddDays(-5.0).ToString("yyyy/M/d"), DateTime.Today.AddDays(-4.0).ToString("yyyy/M/d"), DateTime.Today.AddDays(-3.0).ToString("yyyy/M/d"), DateTime.Today.AddDays(-2.0).ToString("yyyy/M/d"), DateTime.Today.AddDays(-1.0).ToString("yyyy/M/d"), DateTime.Today.ToString("yyyy/M/d") });
            }
            return string.Format("select '{0}'\r\n, (select count(*) from ARCHIVE_DEVICEINFO where date(UpdateData) = date(date_add(now(),interval -6 day))  and DeviceName = '{0}') as  a \r\n, (select count(*) from ARCHIVE_DEVICEINFO where date(UpdateData) =date( date_add(now(),interval -5 day))  and DeviceName = '{0}') as  a \r\n, (select count(*) from ARCHIVE_DEVICEINFO where date(UpdateData) =date( date_add(now(),interval -4 day))  and DeviceName = '{0}') as  a \r\n, (select count(*) from ARCHIVE_DEVICEINFO where date(UpdateData) = date(date_add(now(),interval -3 day)  and DeviceName = '{0}')) as  a \r\n, (select count(*) from ARCHIVE_DEVICEINFO where date(UpdateData) =date( date_add(now(),interval -2 day))  and DeviceName = '{0}') as  a \r\n, (select count(*) from ARCHIVE_DEVICEINFO where date(UpdateData) = date(date_add(now(),interval -1 day))  and DeviceName = '{0}') as  a \r\n, (select count(*) from ARCHIVE_DEVICEINFO where date(UpdateData) = date(now()) and DeviceName = '{0}') as  a  ", name);
        }
        private string getStatisticsSql_dev(string name, string starttime, string endtime, int timebucket)
        {
            ...
            if (timebucket == 1)
            {
                ...
                while (year > 0 || year == 0)
                {
                    string ends = endtime + "-01-01";
                    string ende = endtime + "-12-31";
                    str = str + "," + string.Format("(select count(*) from ARCHIVE_DEVICEINFO where UpdateData between '{0}' and '{1}') as  a \r\n", ends, ende);
                    endtime = Convert.ToString(Convert.ToInt32(endtime) - 1);
                    year--;
                }
                str = str + " from ARCHIVE_BASEINFO  limit 0,1";
            ...
            else if (timebucket == 2)
            {
                ...
                while (month >= 0)
                {
                    string endms = endt.Substring(0, 4) + "-" + endt.Substring(4, 2) + "-01";//开始月初
                    string endme = endmt.Substring(0, 4) + "-" + endmt.Substring(4, 2) + "-01";//开始月末
                    str = str + "," + string.Format("(select count(*) from ARCHIVE_DEVICEINFO where UpdateData >= '{0}' and UpdateData < '{0}') as  a \r\n", endms, endme);
                    endt = dtend.AddMonths(-1).ToString("yyyyMM");
                    endmt = dtmend.AddMonths(-1).ToString("yyyyMM");
                    dtend = dtend.AddMonths(-1);
                    dtmend = dtmend.AddMonths(-1);
            ...
            else if (timebucket == 3)
            {
                ...
                {
                    string ends = endt.Substring(0, 4) + "-" + endt.Substring(4, 2) + "-" + endt.Substring(6, 2);
                    str = str + "," + string.Format("(select count(*) from ARCHIVE_DEVICEINFO where UpdateData = '{0}') as  a \r\n", ends);
                    endt = dte.AddDays(-1.0).ToString("yyyyMMdd");
                    dte = dte.AddDays(-1.0);
                    day--;
                }
