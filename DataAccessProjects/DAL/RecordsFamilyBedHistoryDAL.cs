namespace KangShuoTech.DataAccessProjects.DAL
{
    ...
    public class RecordsFamilyBedHistoryDAL
    {
        ...
        {
            StringBuilder builder = new StringBuilder();
            builder.Append("select count(1) from ARCHIVE_FAMILYBEDHISTORY");
            builder.Append(" where ID=@ID");
            MySqlParameter[] cmdParms = new MySqlParameter[] { new MySqlParameter("@ID", MySqlDbType.Int32, 4) };
            cmdParms[0].Value = ID;
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            builder.Append(" FROM ARCHIVE_FAMILYBEDHISTORY ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            builder.Append(")AS Row, T.*  from ARCHIVE_FAMILYBEDHISTORY T ");
        ...
        public int GetMaxId()
        {
            return MySQLHelper.GetMaxID("ID", "ARCHIVE_FAMILYBEDHISTORY");
        }

        public RecordsFamilyBedHistoryModel GetModel(string IDCardNo)
        {
            StringBuilder builder = new StringBuilder();
            builder.Append("select  ID,PhysicalID,IDCardNo,HospitalName,InHospitalDate,IllcaseNums,Reasons,OutHospitalDate from ARCHIVE_FAMILYBEDHISTORY ");
