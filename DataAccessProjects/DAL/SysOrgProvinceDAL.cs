namespace KangShuoTech.DataAccessProjects.DAL
{
    ...
    public class SysOrgProvinceDAL
    {
        ...
        public SysOrgProvinceModel DataRowToModel(DataRow row)
        {
            SysOrgProvinceModel sysOrgProvinceModel = new SysOrgProvinceModel();
            if (row != null)
            {
                sysOrgProvinceModel.ID = int.Parse(row["ID"].ToString());
                if ((row["Code"] != null) && (row["Code"] != DBNull.Value))
                {
                    sysOrgProvinceModel.Code = row["Code"].ToString();
                }
                if ((row["Name"] != null) && (row["Name"] != DBNull.Value))
                {
                    sysOrgProvinceModel.Name = row["Name"].ToString();
                }
            }
            return sysOrgProvinceModel;
        }
