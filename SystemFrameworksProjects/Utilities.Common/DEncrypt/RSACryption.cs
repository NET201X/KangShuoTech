namespace KangShuoTech.Utilities.Common.DEncrypt
{
    ...
    public class RSACryption
    {
        ...
        {
            byte[] inArray = HashAlgorithm.Create("MD5").ComputeHash(Encoding.GetEncoding("GB2312").GetBytes(m_strSource));
            strHashData = Convert.ToBase64String(inArray);
            return true;
        }
        ...
        public string RSADecrypt(string xmlPrivateKey, string m_strDecryptString)
        {
            ...
            return new UnicodeEncoding().GetString(provider.Decrypt(rgb, false));
        }
        ...
        public string RSADecrypt(string xmlPrivateKey, byte[] DecryptString)
        {
            RSACryptoServiceProvider provider = new RSACryptoServiceProvider();
            provider.FromXmlString(xmlPrivateKey);
            return new UnicodeEncoding().GetString(provider.Decrypt(DecryptString, false));
        }
