namespace KangShuoTech.Utilities.CommunicationData
{
    ...
    internal class ClsALKDEVICETFEx : ClsQCTDeviceEx
    {
        ...
        public override bool ExecQuery(ref byte[] buffName)
        {
            ...
            Thread.Sleep(3000);
            int num = base.m_Comm.RecvData(ref buffName, ref this.ResultData, 13);
            //int num = base.m_Comm.Recv(ref this.ResultData, 7);
            //int num = 0;
            Thread.Sleep(200);
            int err = base.m_Comm.SendData(ref buffName, this.CommandClose);
            Thread.Sleep(200);
            base.m_Comm.SendData(ref buffName, this.CommandClose);
