...
namespace KangShuoTech.Utilities.CommunicationData
{
    ...
    /// 尿液分析
    /// </summary>
    internal class ClsEMPDEVICEUIEx : ClsQCTDeviceEx
    {
        ...
        public override bool ExecQuery(ref byte[] buffName)
        {
            ...
            //int num = 0;
            int num = base.m_Comm.RecvData(ref buffName, ref this.ResultData, 19);
            //Thread.Sleep(200);
            ...
            while (num < 19 || ResultData[0] != 147 || ResultData[1] != 142 || ResultData[2] != 16 ||
                 ResultData[3] != 0 || ResultData[4] != 8 || ResultData[5] != 4 || ResultData[6] == 255 || ResultData[18] == 16)
            {
                ...
                //base.m_Comm.SendData(ref buffName, this.CommandRead);
                num = base.m_Comm.RecvData(ref buffName, ref this.ResultData, 19);
