namespace KangShuoTech.Utilities.CommunicationData
{
    ...
    internal class ClsQCTDEVICEUI : ClsQCTDevice
    {
        ...
        private BCResult GetResult(int index, int code)
        {
        ...
        private bool GetResultList(byte[] buffer)
        {
            ...
            {
                BCResult result = this.GetResult(Convert.ToInt16(buffer2[j]), Convert.ToInt16(buffer2[j + 1]));
