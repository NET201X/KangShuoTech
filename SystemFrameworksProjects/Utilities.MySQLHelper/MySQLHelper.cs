...
namespace KangShuoTech.Utilities.MySQLHelper
{
    /// <summary>
    /// 基于MySQL的数据层基类
    /// </summary>
    public abstract class MySQLHelper
    {
        ...
        public static int ExecuteSqlServer(string strSql, params MySqlParameter[] cmdParms)
        {
            int num;
        ...
        public static void ExecuteSqlTran(ArrayList strArrayList)
        {
            using (MySqlConnection connection = new MySqlConnection(ConnectionString))
            {
                connection.Open();
