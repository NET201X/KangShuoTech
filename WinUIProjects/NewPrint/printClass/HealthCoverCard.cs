...
{
    public class HealthCoverCard : IGetReport
    {
        ...
        public string PrintName
        {
            get
            {
                ...
                {
                    if (area.Equals("禹城") || area.Equals("乐陵")) return "36居民健康体检表(禹城).xps";
                    else if (area.Equals("菏泽")) return "36居民健康体检表(菏泽).xps";
                    else return "36居民健康体检表.xps";
                }
            }
        }
