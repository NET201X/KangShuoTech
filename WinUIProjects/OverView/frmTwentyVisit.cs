...
namespace OverView
{
    public partial class frmTwentyVisit : ChildContentForm, IChildForm, IChildModel<RecordsBaseInfoModel>
    {
        ...
        private void btnQuery_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (this.ckCheckDate.Checked)
                {
                    ...
                    {
                        FollowupDate = string.Format("  between '{0}' and '{1}' ", "2017-10-01", this.dtpEd.Value.Date.ToString("yyyy-MM-dd"));
                    }
                    else
                    {
                ...
                else
                {
                    ...
                    DataSet ds = archive_baseinfo.GetTenVisitRecordCount(where, FollowupDate, "");
                    ...
                    lblOldManCount.Text = archive_baseinfo.GetTenOLDVisitCount(where, FollowupDate) + " 人";
                    lblHypCount.Text = archive_baseinfo.GetTenHyperVisitCount(where, FollowupDate) + " 人";
                    lblDiaCount.Text = archive_baseinfo.GetTenDiaVisitCount(where, FollowupDate) + " 人";
                    lblPsyCount.Text = archive_baseinfo.GetTenMentalVisitCount(where, FollowupDate) + " 人";
                    lblTbCount.Text = archive_baseinfo.GetTenLungerVisitCount(where, FollowupDate) + " 人";
                    lblNczCount.Text = archive_baseinfo.GetTenStrokeVisitCount(where, FollowupDate) + " 人";
                    lblHeaCount.Text = archive_baseinfo.GetTenChdVisitCount(where, FollowupDate) + " 人";
        ...
        private void frmTwentyVisit_Load(object sender, EventArgs e)
        {
            this.ckCheckDate.Visible = false;
            this.dtpSt.Visible = false;
            this.dtpEd.Visible = false;
