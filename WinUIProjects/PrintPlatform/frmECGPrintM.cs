...
{
    public partial class frmECGPrintM : ChildContentForm, IChildForm, IChildModel<RecordsBaseInfoModel>
    {
        ...
        private void frmECGPrintM_Load(object sender, EventArgs e)
        {
        ...
        private void dgvData_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (((this.dgvData.Columns[e.ColumnIndex].HeaderText == "心电图") && (this.bds.Position >= 0)) && (e.RowIndex >= 0))
            {
                ...
                {
                    ECGShowM data = new ECGShowM
                    {
                        FilePath = string.Format(ECGReport + @"\{0}.png ", view.Row["MID"])
                    };
        ...
        private void btnPrintM_Click(object sender, EventArgs e)
        {
            ...
            foreach (DataGridViewRow dr in dgvData.SelectedRows)
            {
                ...
                string strImagePath = string.Format(ECGReport + @"\{0}.png", strexamno);
            ...
            if (imgList.Count > 0)
            {
                string pPath = ECGReport + @"\temp.tiff";
