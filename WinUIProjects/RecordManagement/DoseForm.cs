...
namespace ArchiveInfo
{
    public partial class DoseForm : Form
    {
        ...
        {
            ds = new DataSet();
            /*var dt_dose = new DataTable();
            dt_dose.Columns.Add("name");
            dt_dose.Columns.Add("yongfa");
            dt_dose.Columns.Add("yongliang");
            dt_dose.Columns.Add("leixing");
            dt_dose.Columns.Add("szm");

            ds.Tables.Add(dt_dose);*/
            ...
            ds.Tables[0].RowChanged += new DataRowChangeEventHandler(DoseForm_RowChanged);
            ds.Tables[0].TableNewRow += new DataTableNewRowEventHandler(DoseForm_TableNewRow);
        }

        void DoseForm_TableNewRow(object sender, DataTableNewRowEventArgs e)
        {
        ...
        void DoseForm_RowChanged(object sender, DataRowChangeEventArgs e)
        {
            DataRow dr = e.Row;
