...
namespace ArchiveInfo
{
    ...
    public class ScoreJudge
    {
        ...
        public ScoreJudge(RecordsMedicineResultModel src, string pscore, string pjudge, RadioButton r_y, RadioButton r_qy)
        {
            this.DataSrc = src;
        ...
        public RecordsMedicineResultModel DataSrc { get; set; }
